...
<script language="javascript">
	...
	function checkUserInfo() {
	 if(document.registForm.RegistName.value=="" || document.registForm.RegistPass.value=="" 
			 || document.registForm.RegistEmail.value=="" ){
	    alert("请将信息补充完整！！！");
	    return false;
	 }
	}
	...
	<TBODY>
		<TR vAlign=top>
			...
			<!-- 用postForm表单向result.jsp用GET请求提交数据，注意method属性和action属性的设置
				...
				loginPass参数用来保存密码
			-->
			<span>${msg1 }</span><span>${msg2 }</span>
			<form method="POST" name="registForm" onSubmit="return checkUserInfo()" action="resuser.servlet?op=regist">
			<table width="100%" border="0">
				...
				<tr>
					...
					<td valign="top"><input type="text" name="RegistName" size="19"
						class="input"></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td valign="top"><input type="password" name="RegistPass" size="19"
						class="input"></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td valign="top"><input type="text" name="RegistEmail" size="19"
						class="input"></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<span>已有账号？立即<a href="login.jsp" style="COLOR: blue;">登录</a></span>
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
