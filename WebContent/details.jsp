...
<TABLE cellSpacing=0 cellPadding=0 width=776 align=center border=0>
	<TBODY>
		<TR vAlign=top>
			...
			<table width="90%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<table width="98%" border="0" cellspacing="1" cellpadding="0"
						...
						<tr>
							<td height="21">原价：<strike>人民币${resfood.normprice}元</strike><br>
							<font color="#ff0000">现价：人民币${resfood.realprice}元</font><br>
							${resfood.detail}</td>
						</tr>
					</table>
					</td>
					...
					<table width="145" border="0" cellspacing="1" cellpadding="0">
						<tr>
							<td align="center" width="70"><a href=#
								onClick="window.open('shop_cart.jsp?id=500047&nowmenuid=500001','shopcart','width=580,height=250,resizable=no,scrollbars=yes')"><img
			...
			<!-- 1.指定放大镜样式   2.设置超链接的 href = 图片.src -->
			<a class="MagicZoom" href="images/${resfood.fphoto}">
