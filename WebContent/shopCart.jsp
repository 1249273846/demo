					...
					<tr>
						<td>
							<table width="100%" border="0" align="CENTER" cellpadding="2"
								...
								<c:forEach items="${resshopcart}" var="v">
									<tr bgcolor="#ffffff">
										<td width="50" align="center" height="22"><font
											color="#000000">${v.fid }</font></td>
										<td align="center" height="22"><font color="#000000">${v.fname }</font>
											<input type="hidden" name="prodid" value="500047"></td>
										<td width="104" align="center" height="22"><font
											color="#000000">￥${v.realprice }</font></td>
										<td width="100" class="hh" align="center" height="22">${v.num }</td>
										<td width="116" class="bb" align="center" height="22"><font
											color="#000000">￥${v.sum }</font></td>
									</tr>
								</c:forEach>
								...
								<tr bgcolor="#dadada">
									...
									<td width="100" class="hh" height="22" align="center"><font
										color="#000000">-</font></td>
									<td width="116" class="bb" align="center" height="22"><font
										color="#000000">￥${sum} </font></td>
								</tr>
							</table> <br>
							<table width="300" border="0" cellspacing="1" cellpadding="4"
								align="CENTER" bgcolor="#c0c0c0">
								<tr bgcolor="#dadada">
									<td height="10" align="center"><a href="resshopcart.servlet?op=delete"><font
											color="#000000">清空购物车</font></a></td>
									<td height="10" align="center" style="cursor: hand" ><a href="index.jsp"><font
										color="#000000">继续购物</font></a></td>
									
										<td height="10" align="center" style="cursor: hand">
											<a href="checkOut.jsp"><font color="#000000">生成订单</font></a></td>
								</tr>
							</table>
						</td>
					</tr>
