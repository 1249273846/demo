...
<script language="javascript">
	...
	function checkUserInfo() {
	 if(document.loginForm.loginName.value=="" || document.loginForm.loginPass.value==""){
	    alert("用户名或密码不能为空");
	    return false;
	 }
	}
	...
	<TBODY>
		<TR vAlign=top>
			...
			<!-- 用postForm表单向result.jsp用GET请求提交数据，注意method属性和action属性的设置
				...
				loginPass参数用来保存密码
			-->
			<span>${msg }</span> <span>${msg1 }</span> 
			<form method="POST" name="loginForm" onSubmit="return checkUserInfo()" action="resuser.servlet?op=login">
			<table width="100%" border="0">
				...
				<tr>
					...
					<td valign="top"><input type="text" name="loginName" size="20"
						class="input"></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td valign="top"><input type="password" name="loginPass" size="20"
						class="input"></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					没有账号？立即去<a href="register.jsp" style="COLOR: blue;">注册</a>
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
